...
Flooring (kit_flooring, bath_flooring, liv_flooring, bed_flooring): Resilient flooring (sheet vinyl / lino) that is COVED — it curves and folds UP the wall instead of stopping at a separate skirting board or a grouted tile edge — is sheet VINYL, NOT tile. Tiles meet the wall in a straight grout line with a separate skirting; vinyl coves up the wall. Call coved flooring vinyl and cite the photo.
