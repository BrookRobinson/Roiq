...
const EXTRA_DWELLINGS: ExtraDwelling[] = [
  {
    ...
    aiSummary:
      "A separate ~45m² lined and powered studio sits at the rear (Photo 12). Adds genuine flexible value (home office, guest, or rental) — confirm consent status and any minor-dwelling requirements on the LIM.",
    photoReferences: [12],
  },
];
